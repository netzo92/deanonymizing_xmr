...
- Pool sightings, confirmation timing and node deployment → [private-node observations](research/private-node-observations.md) and the [pool page](../docs/pool.html).
